...
def train_and_evaluate(args):
    ...
    model.fit(X_train, y_train, epochs=200, batch_size=32, verbose=2, callbacks=[EarlyStopping(monitor='val_loss', patience=10, restore_best_weights=True)])
...
if __name__ == '__main__':
    data_path = '../../../features_extraction_both/google/no_trim/IO_01s.csv'
    configurations = [
    ...
    results_df.to_csv('lstm_01s_google_200.csv', index=False)
    print("Training results saved to 'lstm_results_25_google_300.csv'.")
    print(results_df)
