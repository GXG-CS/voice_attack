...
def train_and_evaluate(args):
    ...
    model.fit(X_reshaped, y_categorical, epochs=100, batch_size=32, verbose=2, callbacks=[EarlyStopping(monitor='val_loss', patience=10, restore_best_weights=True)])
...
if __name__ == '__main__':
    data_path = '/Users/xiaoguang_guo@mines.edu/Documents/voice_attack_data/script/features_extraction/alexa/no_trim/IO.csv'
    configurations = [
    ...
    results_df.to_csv('lstm_results_25.csv', index=False)
