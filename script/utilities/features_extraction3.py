...
def extract_features(time_series):
    ...
    if not time_series:
        # Skip processing and return None for empty time_series
        return None
    ...
    kurt = kurtosis(values)
     ...
     # Calculate duration time of the time series data
    duration = times[-1] - times[0]  # Duration in the same units as 'times'
...
# python features_extraction3.py --input_dir ../../data_processed/dilawer11/simple_100_alexa/traffic_W_outgoing_timeSeries_removeD_pickles --output_dir dilawer11/simple_100_alexa/traffic_W_outgoing_features/
# python features_extraction3.py --input_dir ../../data_processed/dilawer11/simple_100_alexa/traffic_W_incoming_timeSeries_removeD_pickles --output_dir dilawer11/simple_100_alexa/traffic_W_incoming_features/
