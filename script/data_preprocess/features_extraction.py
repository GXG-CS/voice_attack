...
def parse_csv(file_path):
    try:
        ...
        sizes = df['Size'].values if 'Size' in df else np.array([])
...
# python features_extraction.py --csv_folder "../../data_processed/vc_200/alexa/resampled_02s" --csv_file_path "../../data_processed/vc_200/alexa/output.csv"
