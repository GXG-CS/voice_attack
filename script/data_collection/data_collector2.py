...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Play audio files in numerical order and capture network traffic based on silence detection.')
    parser.add_argument('--ip', required=True, help='IP address of the RaspberryPi')
    ...
    parser.add_argument('--start_file_number', type=int, default=1, help='The ordinal number of the file to start playback from, based on the numeric value in the filename')
