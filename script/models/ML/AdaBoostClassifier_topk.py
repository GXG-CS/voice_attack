...
base_estimator = DecisionTreeClassifier(max_depth=1)  # Decision tree stumps as weak learners
classifier = AdaBoostClassifier(base_estimator=base_estimator, n_estimators=100, random_state=42)
